...
boggle = {
    ...
    "copyPlayers": (2, 3, 4, 5, 6, 7, 8, 9, 10),
    "compType": "pvp",
    "ownedBy": Currys,
    "length": "",
    "turns": "realTime",
...
temp = {
    ...
    "players": (),  # All possible numbers of players (up to 10)
    "idealPlayers": (),  # Ideal number of players for this game
    "copyPlayers": (),  # How many people can play with one copy of the game
    "compType": "",  # pvp, co-op, teams, modes, or open
